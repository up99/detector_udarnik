...
- Build the `.exe` file using PyInstaller:
  ```bash
  pyinstaller detector.py --windowed --onedir --add-data "runs\detect\train_yolo5nu_augmented_75epochs\weights\best.pt;.\runs\detect\train_yolo5nu_augmented_75epochs\weights" --clean
  ```
